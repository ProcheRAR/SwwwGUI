...
class SwwwGuiWindow(Adw.ApplicationWindow):
    ...
    def _add_about_page(self, dialog):
        ...
        # Create about page
        page = Adw.PreferencesPage()
        page.set_title(self.application.translator.translate("about").capitalize())
        ...
        repo_row.set_title(self.application.translator.translate("github_repo"))
        repo_row.set_subtitle("https://github.com/ProcheRAR/SwwwGUI")
        
        # Visit button
        visit_button = Gtk.Button()
        visit_button.set_icon_name("external-link-symbolic")
